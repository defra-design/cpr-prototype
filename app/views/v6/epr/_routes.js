...
router.post('*/route-reporting-primary', function (req, res) {
    var activityPrimary01a = req.session.data['activityPrimary01a']
    var activityPrimary01b = req.session.data['activityPrimary01b']
    var activityPrimary02 = req.session.data['activityPrimary02']
...
router.post('*/route-reporting-secondary', function (req, res) {
    var activitySecondary01a = req.session.data['activitySecondary01a']
    var activitySecondary01b = req.session.data['activitySecondary01b']
    var activitySecondary02 = req.session.data['activitySecondary02']
